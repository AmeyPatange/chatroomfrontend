app.controller('ChatCtrl', ['$rootScope' ,'$scope', 'socket', '$cookieStore' , function($rootScope ,$scope, socket, $cookieStore) {
    ...
    $scope.$on('sockConnected', function(event, frame) {
    	alert('sockconnected')
    	$scope.userDetails ={};
    	$scope.userDetails= $rootScope.userDetail;
    	console.log($scope.userDetails);
        $scope.userName=$scope.userDetails.fname;
    ...
    $scope.$on('sockConnected', function(event, frame) {
        $scope.userName=$rootScope.userDetail.fname;
  
        $scope.user=$rootScope.userDetail.fname;
        /**
